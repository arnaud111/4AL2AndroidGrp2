...
class GameInfoAdapter(private val games: List<GameInfo>, private val action_destination: Int, private val return_destination: Int) : RecyclerView.Adapter<GameInfoViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GameInfoViewHolder {
        ...
        return GameInfoViewHolder(view, action_destination, return_destination)
    }
